...
Este tempo é chamado na físico-química de MEIA-VIDA. Dada a massa inicial, em
gramas, faça um algoritmo que utilizando estrutura de repetição, determine o tempo
necessário para que essa massa se torne menor que 0.5 gramas. Ao final do algoritmo
escreva a massa inicial e o tempo calculado em horas, minutos e segundos.
